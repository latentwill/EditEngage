...
<div data-testid="step-schedule">
  ...
  <div class="mb-4">
    <label class="block text-base-content/70 text-sm mb-1" for="cron-schedule">Cron Schedule</label>
    <input
      id="cron-schedule"
    ...
    />
    <p class="text-base-content/30 text-xs mt-1">Leave empty for manual runs only</p>
  </div>
